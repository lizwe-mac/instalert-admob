    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mAdView.adListener = object: AdListener() {
            ...
            override fun onAdClicked() {
                ...
                Toast.makeText(this@CrimeActivity, "Thank you for clicking on this ad!", Toast.LENGTH_LONG)
            }
        ...
        findViewById<Button>(R.id.btn_location).setOnClickListener{
            if (ContextCompat.checkSelfPermission(this@CrimeActivity,
                    Manifest.permission.ACCESS_FINE_LOCATION) !==
                PackageManager.PERMISSION_GRANTED) {
                if (ActivityCompat.shouldShowRequestPermissionRationale(this@CrimeActivity,
                        Manifest.permission.ACCESS_FINE_LOCATION)) {
                    ActivityCompat.requestPermissions(this@CrimeActivity,
