    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mAdView.adListener = object: AdListener() {
            ...
            override fun onAdClicked() {
                ...
                Toast.makeText(this@AccidentActivity, "Thank you for clicking on this ad!", Toast.LENGTH_LONG)
            }
        ...
        findViewById<Button>(R.id.btn_location).setOnClickListener{
            if (ContextCompat.checkSelfPermission(this@AccidentActivity,
                    Manifest.permission.ACCESS_FINE_LOCATION) !==
                PackageManager.PERMISSION_GRANTED) {
                if (ActivityCompat.shouldShowRequestPermissionRationale(this@AccidentActivity,
                        Manifest.permission.ACCESS_FINE_LOCATION)) {
                    ActivityCompat.requestPermissions(this@AccidentActivity,
